...
<head>
    ...
    <meta http-equiv="Expires" content="Sat, 01 Dec 2001 00:00:00 GMT">
     <script type="text/javascript">
        ...
        function changeUrl() {
            var page = '/messages.html?number=' + "${messageNumberCounter.number}";
            var ctx = "${pageContext.request.contextPath}";
            var url = ctx + page;

            window.history.replaceState( {} , 'messages',url);
        }
    </script>
    ...
    <form name="form3" style="text-align: left">
        ...
        <table border=0 >
           ...
           <!-- <tr><td colspan="2"></td><td>&nbsp;</td></tr> -->
            <tr><td colspan="2"><TEXTAREA name="messageText" rows="4" cols="50"></TEXTAREA></td><td><img id="msg" src="resources/images/new-message.png" title="Click to reload the message" onclick="changeUrl();reloadPage()" height="70" width="70"></td></tr>
